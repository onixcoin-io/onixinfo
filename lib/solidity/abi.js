...
const orc20List = require('./orc20-abi.json')
const orc721List = require('./orc721-abi.json')
...
const orc20ABIs = transformABIList(orc20List)
const orc721ABIs = transformABIList(orc721List)

Object.assign(exports, {MethodABI, EventABI, orc20ABIs, orc721ABIs})
